...
def parse_execution(data, file_names):
    ...
    coleta.chave_coleta = IDColeta("mprs", month, year)
    coleta.orgao = "mprs"
    coleta.mes = int(month)
    coleta.ano = int(year)
    coleta.repositorio_coletor = "https://github.com/dadosjusbr/coletor-mprs"
...
def main():
    ...
    file_names = ['test/membros-ativos-contracheque-06-2020.csv']
